...
using SecurityDemoX.Blazor.Server.Services;
...
using SecurityDemoX.WebApi.JWT;

namespace SecurityDemoX.Blazor.Server {
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services) {
            ...
            services.AddXaf<SecurityDemoXBlazorApplication>(Configuration);
            ...
            services.AddXafSecurity(options => {
                options.RoleType = typeof(Module.BusinessObjects.EmployeeRole);
            ...
            services.AddSwaggerGen(c => {
                ...
                c.SwaggerDoc("v1", new OpenApiInfo {
                    Title = "SecurityDemoX API",
                    Version = "v1",
                    Description = @"Use AddXafWebApi(options) in the SecurityDemoX.Blazor.Server\Startup.cs file to make Business Objects available in the Web API."
                });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
            if(env.IsDevelopment()) {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "SecurityDemoX WebApi v1");
                });
            }
            else {
