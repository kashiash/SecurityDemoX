...
namespace SecurityDemoX.Blazor.Server {
    public partial class SecurityDemoXBlazorApplication : BlazorApplication {
        public SecurityDemoXBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void SecurityDemoXBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
